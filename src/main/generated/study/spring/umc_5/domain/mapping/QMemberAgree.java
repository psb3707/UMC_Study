...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = -800536655L;
    ...
    public final study.spring.umc_5.domain.QTerms terms;
    ...
    public QMemberAgree(Class<? extends MemberAgree> type, PathMetadata metadata, PathInits inits) {
        ...
        this.terms = inits.isInitialized("terms") ? new study.spring.umc_5.domain.QTerms(forProperty("terms")) : null;
    }
