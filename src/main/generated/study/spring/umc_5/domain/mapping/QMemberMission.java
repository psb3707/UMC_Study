...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1602136401L;
    ...
    public final study.spring.umc_5.domain.QMission mission;

    public final EnumPath<study.spring.umc_5.domain.enums.MissionStatus> missionStatus = createEnum("missionStatus", study.spring.umc_5.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new study.spring.umc_5.domain.QMission(forProperty("mission")) : null;
    }
