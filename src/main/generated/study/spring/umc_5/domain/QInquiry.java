...
public class QInquiry extends EntityPathBase<Inquiry> {
    ...
    private static final long serialVersionUID = -464874266L;
    ...
    public final EnumPath<study.spring.umc_5.domain.enums.InquiryStatus> status = createEnum("status", study.spring.umc_5.domain.enums.InquiryStatus.class);
